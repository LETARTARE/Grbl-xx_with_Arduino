...
/// by  LETARTARE and DavidLQuick
  // Split the init message to imporove compatability with Java apps looking for the GRBL version using REGEX
/// 845 : add the axes
    printPgmString(PSTR("\r\nMega2560 with 4 axes "));
	printPgmString(PSTR("\r\nGrbl " GRBL_VERSION "  " GRBL_AXIS));
/// <-
