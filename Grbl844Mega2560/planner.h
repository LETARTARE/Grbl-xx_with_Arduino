...
typedef struct {
  ...
  uint32_t steps_x, steps_y, steps_z,
           steps_t;                   // Step count along each axis
/// 843 : int32_t -> uint32_t  ???
  //int32_t  step_event_count;          // The number of step events required to complete this block
  uint32_t  step_event_count;          // The number of step events required to complete this bloc
/// <--
...
void plan_buffer_line(double x, double y, double z, double a, double feed_rate, uint8_t invert_feed_rate);
