...
void protocol_status_report()
{
 ...
 memcpy(print_position,sys.position,sizeof(sys.position));
   ...
   printString(","); printFloat(print_position[A_AXIS]/(settings.steps_per_mm[A_AXIS]*MM_PER_INCH));
   ...
   printString(","); printFloat((print_position[A_AXIS]/settings.steps_per_mm[A_AXIS]-sys.coord_system[sys.coord_select][A_AXIS]-sys.coord_offset[A_AXIS])/MM_PER_INCH);
 #else
   ...
   printString(","); printFloat(print_position[A_AXIS]/(settings.steps_per_mm[A_AXIS]));
   ...
   printString(","); printFloat(print_position[A_AXIS]/settings.steps_per_mm[A_AXIS]-sys.coord_system[sys.coord_select][A_AXIS]-sys.coord_offset[A_AXIS]);
 #endif
 printString("]\r\n");
}
